...
Lab6::Lab6(GLFWWindowImpl& win) : Layer(win)
{
	...
	floorShaderdesc.vertexSrcPath = "./assets/Shaders/Lab6/FloorVert.glsl";
	floorShaderdesc.geometrySrcPath = "./assets/Shaders/Lab6/Floorgeo.glsl";
	floorShaderdesc.fragmentSrcPath = "./assets/Shaders/Lab6/FloorFrag.glsl";
	...
	treeShaderdesc.vertexSrcPath = "./assets/Shaders/Lab6/BillBoardVert.glsl";
	treeShaderdesc.geometrySrcPath = "./assets/Shaders/Lab6/BillBoardGeo.glsl";
	treeShaderdesc.fragmentSrcPath = "./assets/Shaders/Lab6/BillBoardFrag.glsl";
