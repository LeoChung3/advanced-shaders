...
Lab8::Lab8(GLFWWindowImpl& win) : Layer(win)
{
	...
	floorShaderdesc.vertexSrcPath = "./assets/Shaders/Lab8/FloorVert.glsl";
	floorShaderdesc.controlSrcPath = "./assets/Shaders/Lab8/FloorTCS.glsl";
	floorShaderdesc.evaluationSrcPath = "./assets/Shaders/Lab8/FloorTES.glsl";
	floorShaderdesc.geometrySrcPath = "./assets/Shaders/Lab8/Floorgeo.glsl";
	floorShaderdesc.fragmentSrcPath = "./assets/Shaders/Lab8/FloorFrag.glsl";
	...
	textureComputeDesc.computeSrcPath = "./assets/Shaders/lab8/computerShaderTest.glsl";
	...
	computeMaterial->setValue("u_image", heightmapping);
	...
	img.imageUnit = textureComputePass.material->m_shader->m_imageBindingPoints["outputImg"];
...
void Lab8::onUpdate(float timestep)
{
	...
	//floormat->setValue("u_heightMap", computepass.images[0].texture);
	//floormat->setValue("normalmap", computepass.images[0].texture);
