...
Lab3::Lab3(GLFWWindowImpl& win) : Layer(win)
{
	...
	phongShaderDesc.vertexSrcPath = "./assets/Shaders/Lab3/PhongVert.glsl";
	phongShaderDesc.fragmentSrcPath = "./assets/Shaders/Lab3/PhongFrag.glsl";
	...
	floorShaderdesc.vertexSrcPath = "./assets/Shaders/Lab3/FloorVert.glsl";
	floorShaderdesc.fragmentSrcPath = "./assets/Shaders/Lab3/FloorFrag.glsl";
	...
	boxShaderdesc.vertexSrcPath = "./assets/Shaders/Lab3/BoxVert.glsl";
	boxShaderdesc.fragmentSrcPath = "./assets/Shaders/Lab3/BoxFrag.glsl";
...
//===================================================================================================================================
	...
	Screendesc.vertexSrcPath = "./assets/Shaders/Lab3/Screenvert.glsl";
	Screendesc.fragmentSrcPath = "./assets/Shaders/Lab3/ScreenFrag.glsl";
